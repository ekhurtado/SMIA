...
module.exports = function (electronApp, menuState) {
  ...
  {
    label: 'SMIA GitHub',
    accelerator: 'CommandOrControl+[',  // can also be executed using the keyboard shortcut "Ctrl+'"
    enabled: () => menuState.bpmn,
    action: function() {
      var shell = require('electron').shell;
      shell.openExternal('https://github.com/ekhurtado/SMIA/');
    }
  }, {
    label: 'SMIA Documentation',
    accelerator: 'CommandOrControl+]',
    enabled: () => menuState.bpmn,
    action: function() {
      var shell = require('electron').shell;
      shell.openExternal('https://smia.readthedocs.io/en/latest/index.html');
    }
  }]
}
