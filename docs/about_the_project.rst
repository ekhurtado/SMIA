...
The Self-configurable Manufacturing Industrial Agent (SMIA) project represents the ongoing development of a solution that aims to achieve a proposal for the implementation of the concept of the I4.0 Component from the Reference Architectural Model Industrie 4.0 (RAMI 4.0) as an AAS-compliant agent-based Digital Twin (DT). This development is performed within a PhD thesis at the University of the Basque Country (UPV/EHU), specifically in the Control and Systems Integration research group.
